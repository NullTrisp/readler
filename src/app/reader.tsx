  ...
  return <View style={styles.container}><StatusBar hidden={!controls} style="light" />
    ...
    {controls && <SafeAreaView pointerEvents="box-none" style={StyleSheet.absoluteFill}>
      ...
      <View style={styles.bottom}><Pressable accessibilityRole="adjustable" accessibilityLabel={t('positionSlider')}
        ...
        <View style={styles.navigation}><Pressable accessibilityRole="button" accessibilityLabel={t('previous')} onPress={() => reader.current?.previous()} style={styles.control}><View style={styles.controlLabel}><SymbolView name={{ ios: 'chevron.left', android: 'chevron_left', web: 'chevron_left' }} size={18} tintColor="#fff" /><AppText style={styles.controlText}>{t('previous')}</AppText></View></Pressable>
          ...
          <Pressable accessibilityRole="button" accessibilityLabel={t('next')} onPress={() => reader.current?.next()} style={styles.control}><View style={styles.controlLabel}><AppText style={styles.controlText}>{t('next')}</AppText><SymbolView name={{ ios: 'chevron.right', android: 'chevron_right', web: 'chevron_right' }} size={18} tintColor="#fff" /></View></Pressable></View>
      </View>
    </SafeAreaView>}
  </View>;
}
